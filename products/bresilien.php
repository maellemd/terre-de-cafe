...
<head>
  ...
  <title>Café Brésilien - Terre de Café</title>
...
<nav>
    ...
    <section id="prodetails" class="section1">
        <div class="single-pro-image">
            <img src="../img/produits/brazil-coffee.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="../img/produits/brazil-coffee.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="../img/produits/cafe-grains1.jpg" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="../img/produits/cafe-grains2.jpg" width="100%" class="small-img" alt="">
                </div>
            
                <div class="small-img-col">
                    <img src="../img/produits/cafe-moulu.jpg" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
    ...
    <button type="submit" class="normal">Ajouter au panier</button>
                ...
                <h4>Détails</h4>
                <span>Un trésor des plantations luxuriantes du Brésil, ce café incarne la richesse du terroir sud-américain. Cultivé sous le soleil généreux des régions comme Minas Gerais ou São Paulo, il offre des notes de cacao intense, de fruits secs et parfois de caramel. Souvent issu de la méthode naturelle, qui préserve les sucres du fruit, ce café séduit par son corps rond et sa douceur enveloppante.</span>
            </div>
    </section>
...
$product_id = 2;  // ID du café brésilien
?>
<!-- Le reste de l'en-tête HTML reste identique -->
...
<div class="product-container">
    ...
    <div class="pro" onclick="window.location.href='viennois.php';">
        <img src="../img/pro-page/viennese-coffee.png" alt="Café Viennois">
        <div class="des">
            <span>Café</span>
            <h5>Café Viennois</h5>
            <div class="star">
        ...
        <form action="../cart/addCart.php" method="POST" class="cart-form">
            <input type="hidden" name="id" value="7">  <!-- ID du café viennois -->
            <input type="hidden" name="quantity" value="1">
            <input type="hidden" name="packaging" value="250">
            <button type="submit" class="cart-icon">
                <i class="fa fa-shopping-cart" aria-hidden="true"></i>
