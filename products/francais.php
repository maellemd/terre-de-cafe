...
<head>
  ...
  <title>Café Français - Terre de Café</title>
  ...
  <section id="header">
    ...
    <section id="prodetails" class="section1">
        <div class="single-pro-image">
            <img src="../img/produits/french-coffee.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="../img/produits/french-coffee.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
    ...
    <button type="submit" class="normal">Ajouter au panier</button>
                ...
                <h4>Détails</h4>
                <span>Symbolisant l’élégance et l’intensité, le café français est souvent associé à l’art de vivre à la française. Préparé en espresso ou en café filtre, il est réputé pour son corps corsé et ses arômes grillés, parfois accompagnés d’une touche de fruits noirs. Torréfié plus foncé, il reflète l'amour des Français pour une saveur prononcée qui accompagne idéalement un croissant au petit matin.</span>
            </div>
    </section>
