...
<head>
  ...
  <title>Café Italien - Terre de Café</title>
  ...
  <section id="header">
    ...
    <section id="prodetails" class="section1">
        <div class="single-pro-image">
            <img src="../img/produits/italian-coffee.png" width="100%" id="MainImg" alt="Café Italien">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="../img/produits/italian-coffee.png" width="100%" class="small-img" alt="Café Italien">
                </div>
                <div class="small-img-col">
        ...
        <div class="single-pro-details">
            ...
            <h4>Détails</h4>
            <span>Puissant et audacieux, le café italien est un hommage à la tradition espresso. Torréfié à l'italienne – une torréfaction sombre qui fait ressortir des saveurs de cacao amer et de noix grillées – il est le cœur de chaque espresso crémeux dégusté dans les cafés de Rome ou Milan. Ce café est une véritable expérience sensorielle, un rituel aussi intense que rapide, où chaque gorgée est un voyage en Italie.</span>
        </div>
    </section>
