...
<head>
  ...
  <title>Café Kenyan - Terre de Café</title>
...
<nav>
    ...
    <section id="prodetails" class="section1">
        <div class="single-pro-image">
            <img src="../img/produits/kenya-coffee.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="../img/produits/kenya-coffee.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
    ...
    <button type="submit" class="normal">Ajouter au panier</button>
                ...
                <span>Cultivé sur les sols volcaniques fertiles des hauts plateaux kenyans, ce café est une explosion de saveurs. Avec son profil unique, il révèle des notes vives de fruits rouges, d’agrumes, et une acidité brillante qui ravit les amateurs de cafés complexes. Souvent traité par voie humide, ce café est le reflet d’un savoir-faire ancestral et de l’héritage des coopératives locales qui travaillent avec soin pour produire ce nectar.</span>
            </div>
    </section>
    ...
    <button type="submit" class="cart-icon">
        <i class="fa fa-shopping-cart" aria-hidden="true"></i>
            ...
            <div class="pro"onclick="window.location.href='marocain.php';">
                <img src="../img/pro-page/morocan-coffee.png" alt="Café Marocain">
                <div class="des">
                    <span>Café</span>
                    <h5>Café Marocain</h5>
                    <div class="star">
