...
<head>
  ...
  <title>Café Marocain - Terre de Café</title>
...
<nav>
    ...
    <section id="prodetails" class="section1">
        <div class="single-pro-image">
            <img src="../img/produits/morocan-coffee.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="../img/produits/morocan-coffee.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
    ...
    <button type="submit" class="normal">Ajouter au panier</button>
                ...
                <h4>Détails</h4>
                <span>Une invitation au voyage, le café marocain est souvent associé aux épices envoûtantes comme la cannelle, la cardamome ou la muscade. Traditionnellement dégusté dans des salons où le temps ralentit, il reflète l’hospitalité chaleureuse du Maroc. Généralement corsé, son goût est rehaussé par une touche aromatique qui le rend unique. Une expérience envoûtante pour les sens.</span>
            </div>
    </section>
