...
<head>
    ...
    <title>Café New-Orleans - Terre de Café</title>
...
<body>
    ...
    <section id="prodetails" class="section1">
        <div class="single-pro-image">
            <img src="../img/produits/new-orleans-coffee.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="../img/produits/new-orleans-coffee.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
        ...
        <div class="single-pro-details">
            <h6>Nos cafés</h6>
            <h4>Le café Nouvelle-Orléans</h4>
            <h2>12.99€</h2>
            ...
            <h4>Détails</h4>
            <span>Originaire de la Nouvelle-Orléans, ce café unique se distingue par l'ajout de chicorée torréfiée, qui lui donne une saveur légèrement sucrée et boisée. Il est souvent préparé en café filtre et servi avec du lait chaud pour un "café au lait" typique. Ce mélange trouve ses racines dans la pénurie de café au XIXe siècle, où les habitants ont découvert que la chicorée ajoutait profondeur et caractère à leur boisson préférée.</span>
        </div>
    </section>
